...
import { CreateUserRequest, HTTP_STATUS_CODES, newRequest, RESPONSE_TYPES } from '@/dtos'
import { buildJsonApiResponse, getErrorResponse } from '@/helpers'
...
export async function createUser(req: Request, res: Response) {
  try {
    ...
    res
      ...
      .send(buildJsonApiResponse({ id: dbResp.id }, RESPONSE_TYPES.USERS))
  } catch (error) {
